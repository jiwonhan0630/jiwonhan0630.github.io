...
## 몬스터 및 보스 패턴 시스템
- 데이터 테이블을 통해 상태와 전이 조건을 정의하는 몬스터 패턴 시스템 구현 [(Project C)]({% link works/0101-projectpz %}).
- StateMachineBehaviour를 활용하여 애니메이션 상태와 로직을 1:1로 매핑한 보스 패턴 시스템 구현 [(Project I)]({% link works/0103-projecti %}).
