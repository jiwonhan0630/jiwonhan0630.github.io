...
[보유기술 소개]({% link _works/0001_skill.md %}){: .button .subject-negative .center sub="사용 가능한 언어와 툴, 소프트웨어 등"}
[자랑거리 소개]({% link _works/0003_worksHighlight.md %}){: .button .subject-negative .center sub="각 프로젝트별 담당 업무 중 자랑스러운 부분들"}