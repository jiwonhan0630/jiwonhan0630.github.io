...
<article class="panelbox">
<h2 class="panelbox-title">Attribute 기반의 자동 이벤트 바인딩 시스템</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">CSV Utility</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">Naming Tool</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">레벨 에디팅 툴 및 베이킹 툴</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">장비 아이템 착용 위치 에디터</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">Addressables 시스템 확장</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">절차적 레벨 생성</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">물리 기반 자율 주행 및 파츠 시스템</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">산업 데이터 기반 게이미피케이션</h2>
<div class="panelbox-item" markdown="1">
...
<article class="panelbox">
<h2 class="panelbox-title">몬스터 및 보스 패턴 시스템</h2>
<div class="panelbox-item" markdown="1">
